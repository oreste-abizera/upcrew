...
import { FaFacebook, FaGithub, FaYoutube, FaGlobe, FaTwitter, FaLinkedin, FaGitlab, FaBitbucket, FaSkype, FaWhatsapp, FaInstagram } from "react-icons/fa";
        ...
        <div className="container-fluid mt-4">
          <div className="row">
            {this.state.teamData.map((item) => (
              <div
                key={item.id}
                className="col-10 col-sm-8 col-md-6 col-lg-5 mx-auto my-5"
              >
                <div className="team-item col-12 col-md-10 mx-auto pb-4 pt-5">
