...
export default function ListQuestion({ data, index: number }) {
  const { type, _id, question, options, score, answer } = data;
  ...
  return (
    <div className="container">
      ...
      <div className="answer-description ml-4">
        ...
        <div className="score">
          <p>
            ...
            <span>
              <span className="text-main">/ {score} marks</span>
            </span>
          </p>
        </div>
      </div>
      <div className="actions d-flex">
        <Modal
          id={`editquestion${_id}`}
          header="Change question info"
          opener={true}
          body={<EditQuestion question={data}></EditQuestion>}
        >
