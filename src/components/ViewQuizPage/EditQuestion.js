...
export default function EditQuestion({
  ...
  const {
    type,
    question_id = "12345676347786889644434575",
    question,
    options = [],
    score,
    answer,
      ...
      <form className="form-container" onSubmit={handleSaveQuestion}>
        <div className="form-group">
          ...
          >
            ...
            <option value={"TEXT"}>Writing question</option>
          </select>
        </div>
          ...
          <div className="form-group">
            ...
            <div className="container-fluid row col">
              {optionsData.map((record) => (
                <div
                  key={record.id}
                  className="col-6 col-md-4 my-1 option-container"
                >
                  <MdClose
        ...
        <div className="form-group">
          <input
            ...
            value={edit ? "Save Changes" : "Add Question"}
          ></input>
        </div>
      </form>
    </div>
