...
export default function CoursesListItem({ course = {}, me, showAlert, reloadContent }) {
    ...
    return (
        <div className="text-center col-10 col-md-4 col-lg-3 m-3 p-3 course-container">
            <h2>{course.name}</h2>
            ...
            <div className="course-actions d-flex col-6 col-md-7 mx-auto my-3">
                <Modal id={`course${course.id}`} header="Update Course" opener={true} body={<EditCourse me={me} showAlert={showAlert} reloadContent={reloadContent} id={`course${course.id}`} course={course}></EditCourse>}>
                    <button
