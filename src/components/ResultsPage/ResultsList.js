...
export default function ResultsList() {
  ...
  return (
    <div>
      <Heading title="CHOOSE RESULT"></Heading>
      {/* <ResultsFilters></ResultsFilters> */}
      {
        <p className="text-center my-3">
          {validAssignments.length} results found
        </p>
      }
      ...
      {validAssignments.map((item, index) => (
